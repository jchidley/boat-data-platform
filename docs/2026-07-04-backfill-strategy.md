...
The native MasterBus settled-file gate used equivalent explicit limits and additionally recorded source event times, converter/skips, sparse-merge counts, workspace, free disk and peak RSS. The complete evidence is in `2026-07-05-copy-merge-validation.md`. That staging evidence did not itself constitute live approval; the first native file was subsequently approved explicitly, imported live and verified on 2026-07-21. No live N2K import has been approved or run.
