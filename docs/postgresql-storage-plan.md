...
The committed executable disposable PostgreSQL regression test covers these semantics without requiring TimescaleDB. The migration was deployed live on 2026-07-21 and rebuilt successfully against the empty typed source; Grafana provisioning and typed batch import remain approval/prerequisite-gated.
