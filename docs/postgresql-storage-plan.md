...
The committed executable disposable PostgreSQL regression test covers these semantics without requiring TimescaleDB. It is repository/staging verification only; live migration deployment and Grafana provisioning remain approval/prerequisite-gated.
