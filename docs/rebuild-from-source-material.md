...
Do not use the active hourly MasterBus file, live Signal K output, or live `pi5nvme` for broad rebuild validation. The engine migration and first explicitly approved settled native batch were deployed live and verified on 2026-07-21; additional typed imports and dashboard provisioning remain explicit approval/prerequisite gates.
