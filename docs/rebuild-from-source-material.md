...
Do not use the active hourly MasterBus file, live Signal K output, or live `pi5nvme` for broad rebuild validation. The engine migration was deployed live and verified against the empty typed source on 2026-07-21; live typed import and dashboard provisioning remain explicit approval/prerequisite gates.
