...
BEGIN
  ...
  INSERT INTO n2k_position_rapid_129025_v2(raw_file_id, message_index, time, source_address, device_id, latitude_deg, longitude_deg)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.latitude_deg, s.longitude_deg
  ...
  ON CONFLICT (time, raw_file_id, message_index) DO UPDATE SET
    source_address = EXCLUDED.source_address,
    latitude_deg = EXCLUDED.latitude_deg,
    longitude_deg = EXCLUDED.longitude_deg;

  INSERT INTO n2k_cog_sog_129026_v2(raw_file_id, message_index, time, source_address, device_id, sequence_id, reference, cog_rad, sog_ms)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sequence_id, s.reference, s.cog_rad, s.sog_ms
  ...
  INSERT INTO n2k_gnss_position_129029_v2(raw_file_id, message_index, time, source_address, device_id, sequence_id, days_since_1970, seconds_since_midnight, latitude_deg, longitude_deg, altitude_m, gnss_type, method, integrity, satellites, hdop, pdop, geoidal_separation_m, reference_stations)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sequence_id, s.days_since_1970, s.seconds_since_midnight, s.latitude_deg, s.longitude_deg, s.altitude_m, s.gnss_type, s.method, s.integrity, s.satellites, s.hdop, s.pdop, s.geoidal_separation_m, s.reference_stations
  ...
  INSERT INTO n2k_heading_127250_v2(raw_file_id, message_index, time, source_address, device_id, sequence_id, heading_rad, deviation_rad, variation_rad, reference)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sequence_id, s.heading_rad, s.deviation_rad, s.variation_rad, s.reference
  ...
  INSERT INTO n2k_rudder_127245_v2(raw_file_id, message_index, time, source_address, device_id, instance, direction_order, angle_order_rad, position_rad)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.instance, s.direction_order, s.angle_order_rad, s.position_rad
  ...
  INSERT INTO n2k_rate_of_turn_127251_v2(raw_file_id, message_index, time, source_address, device_id, sid, rate_rad_s)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.rate_rad_s
  ...
  INSERT INTO n2k_attitude_127257_v2(raw_file_id, message_index, time, source_address, device_id, sid, yaw_rad, pitch_rad, roll_rad)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.yaw_rad, s.pitch_rad, s.roll_rad
  ...
  INSERT INTO n2k_magnetic_variation_127258_v2(raw_file_id, message_index, time, source_address, device_id, sid, source, variation_rad)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.source, s.variation_rad
  ...
  INSERT INTO n2k_water_speed_128259_v2(raw_file_id, message_index, time, source_address, device_id, speed_water_referenced_ms, speed_ground_referenced_ms, speed_water_type)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.speed_water_referenced_ms, s.speed_ground_referenced_ms, s.speed_water_type
  ...
  INSERT INTO n2k_water_depth_128267_v2(raw_file_id, message_index, time, source_address, device_id, sid, depth_below_transducer_m, offset_m, range_m)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.depth_below_transducer_m, s.offset_m, s.range_m
  ...
  INSERT INTO n2k_distance_log_128275_v2(raw_file_id, message_index, time, source_address, device_id, days_since_1970, seconds_since_midnight, log_m, trip_log_m)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.days_since_1970, s.seconds_since_midnight, s.log_m, s.trip_log_m
  ...
  INSERT INTO n2k_route_waypoint_129285_v2(raw_file_id, message_index, time, source_address, device_id, start_rps, item_count, database_id, route_id, navigation_direction, supplementary_data_available, route_name, waypoint_index, waypoint_id, waypoint_name, waypoint_latitude_deg, waypoint_longitude_deg)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.start_rps, s.item_count, s.database_id, s.route_id, s.navigation_direction, s.supplementary_data_available, s.route_name, s.waypoint_index, s.waypoint_id, s.waypoint_name, s.waypoint_latitude_deg, s.waypoint_longitude_deg
  FROM n2k_route_waypoint_129285_stage_v2 s
  WHERE s.raw_file_id = p_raw_file_id
  ON CONFLICT (time, raw_file_id, message_index, waypoint_index) DO UPDATE SET
    source_address = EXCLUDED.source_address,
  ...
  INSERT INTO n2k_ais_class_a_position_129038_v2(raw_file_id, message_index, time, source_address, device_id, message_id, repeat_indicator, user_id, longitude_deg, latitude_deg, position_accuracy, raim, time_stamp, cog_rad, sog_ms, communication_state, ais_transceiver_information, heading_rad, rate_of_turn_rad_s, nav_status, special_maneuver_indicator, sequence_id)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.message_id, s.repeat_indicator, s.user_id, s.longitude_deg, s.latitude_deg, s.position_accuracy, s.raim, s.time_stamp, s.cog_rad, s.sog_ms, s.communication_state, s.ais_transceiver_information, s.heading_rad, s.rate_of_turn_rad_s, s.nav_status, s.special_maneuver_indicator, s.sequence_id
  ...
  INSERT INTO n2k_ais_class_b_position_129039_v2(raw_file_id, message_index, time, source_address, device_id, message_id, repeat_indicator, user_id, longitude_deg, latitude_deg, position_accuracy, raim, time_stamp, cog_rad, sog_ms, communication_state, ais_transceiver_information, heading_rad, unit_type, integrated_display, dsc, band, can_handle_msg_22, ais_mode, ais_communication_state)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.message_id, s.repeat_indicator, s.user_id, s.longitude_deg, s.latitude_deg, s.position_accuracy, s.raim, s.time_stamp, s.cog_rad, s.sog_ms, s.communication_state, s.ais_transceiver_information, s.heading_rad, s.unit_type, s.integrated_display, s.dsc, s.band, s.can_handle_msg_22, s.ais_mode, s.ais_communication_state
  ...
  INSERT INTO n2k_ais_class_a_static_129794_v2(raw_file_id, message_index, time, source_address, device_id, message_id, repeat_indicator, user_id, imo_number, callsign, name, ship_type, length_m, beam_m, position_reference_starboard_m, position_reference_bow_m, eta_days_since_1970, eta_seconds_since_midnight, draft_m, destination, ais_version_indicator, gnss_type, dte, ais_transceiver_information)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.message_id, s.repeat_indicator, s.user_id, s.imo_number, s.callsign, s.name, s.ship_type, s.length_m, s.beam_m, s.position_reference_starboard_m, s.position_reference_bow_m, s.eta_days_since_1970, s.eta_seconds_since_midnight, s.draft_m, s.destination, s.ais_version_indicator, s.gnss_type, s.dte, s.ais_transceiver_information
  ...
  INSERT INTO n2k_ais_class_b_static_a_129809_v2(raw_file_id, message_index, time, source_address, device_id, message_id, repeat_indicator, user_id, name, ais_transceiver_information, sequence_id)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.message_id, s.repeat_indicator, s.user_id, s.name, s.ais_transceiver_information, s.sequence_id
  ...
  INSERT INTO n2k_ais_class_b_static_b_129810_v2(raw_file_id, message_index, time, source_address, device_id, message_id, repeat_indicator, user_id, ship_type, vendor_id, callsign, length_m, beam_m, position_reference_starboard_m, position_reference_bow_m, mothership_user_id, gnss_type, ais_transceiver_information, sequence_id)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.message_id, s.repeat_indicator, s.user_id, s.ship_type, s.vendor_id, s.callsign, s.length_m, s.beam_m, s.position_reference_starboard_m, s.position_reference_bow_m, s.mothership_user_id, s.gnss_type, s.ais_transceiver_information, s.sequence_id
  ...
  INSERT INTO n2k_gnss_dops_129539_v2(raw_file_id, message_index, time, source_address, device_id, sid, desired_mode, actual_mode, hdop, vdop, tdop)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.desired_mode, s.actual_mode, s.hdop, s.vdop, s.tdop
  ...
  INSERT INTO n2k_gnss_satellites_129540_v2(raw_file_id, message_index, time, source_address, device_id, sid, range_residual_mode, sats_in_view, satellite_index, prn, elevation_rad, azimuth_rad, snr_db, range_residual_m, status)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.range_residual_mode, s.sats_in_view, s.satellite_index, s.prn, s.elevation_rad, s.azimuth_rad, s.snr_db, s.range_residual_m, s.status
  FROM n2k_gnss_satellites_129540_stage_v2 s
  WHERE s.raw_file_id = p_raw_file_id
  ON CONFLICT (time, raw_file_id, message_index, satellite_index) DO UPDATE SET
    source_address = EXCLUDED.source_address,
    sid = EXCLUDED.sid,
  ...
  INSERT INTO n2k_wind_130306_v2(raw_file_id, message_index, time, source_address, device_id, sid, wind_speed_ms, wind_angle_rad, reference)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.wind_speed_ms, s.wind_angle_rad, s.reference
  ...
  INSERT INTO n2k_environment_130310_v2(raw_file_id, message_index, time, source_address, device_id, sid, water_temperature_k, outside_ambient_air_temperature_k, atmospheric_pressure_pa)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.water_temperature_k, s.outside_ambient_air_temperature_k, s.atmospheric_pressure_pa
  ...
  INSERT INTO n2k_environment_130311_v2(raw_file_id, message_index, time, source_address, device_id, sid, temperature_source, humidity_source, temperature_k, humidity_ratio, atmospheric_pressure_pa)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.temperature_source, s.humidity_source, s.temperature_k, s.humidity_ratio, s.atmospheric_pressure_pa
  ...
  INSERT INTO n2k_temperature_130312_v2(raw_file_id, message_index, time, source_address, device_id, sid, instance, source, actual_temperature_k, set_temperature_k)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.instance, s.source, s.actual_temperature_k, s.set_temperature_k
  ...
  INSERT INTO n2k_pressure_130314_v2(raw_file_id, message_index, time, source_address, device_id, sid, instance, source, pressure_pa)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.instance, s.source, s.pressure_pa
  ...
  INSERT INTO n2k_temperature_ext_130316_v2(raw_file_id, message_index, time, source_address, device_id, sid, instance, source, temperature_k, set_temperature_k)
  SELECT s.raw_file_id, s.message_index, s.time, s.source_address, NULL, s.sid, s.instance, s.source, s.temperature_k, s.set_temperature_k
  ...
  INSERT INTO n2k_research_fields_v2(raw_file_id, message_index, time, pgn, source_address, field_name, value_double, value_text, value_bool)
  SELECT s.raw_file_id, s.message_index, s.time, s.pgn, s.source_address, s.field_name, s.value_double, s.value_text, s.value_bool
  FROM n2k_research_fields_stage_v2 s
  WHERE s.raw_file_id = p_raw_file_id
  ON CONFLICT (time, raw_file_id, message_index, field_name) DO UPDATE SET
    pgn = EXCLUDED.pgn,
    source_address = EXCLUDED.source_address,
